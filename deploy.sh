...
if [[ $SCOPE == "frontend" || $SCOPE == "all" ]]; then
  ...
  $NOTIFIER ":small_blue_diamond: FRONTEND - DEPLOY STARTED"
  ...
  $NOTIFIER ":small_blue_diamond: FRONTEND - DEPLOY COMPLETED"
fi
